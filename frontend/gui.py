...
TOOLBAR_TEXT = "text-black text-xl font-bold px-6 py-2 rounded-lg transition-all no-underline"
...
class Gui:
    ...
    def navbar():
        with ui.row().classes(TOOLBAR_ROW):
            ...
            ui.link("Activity", "/activity").classes(f"{TOOLBAR_TEXT} {TOOLBAR_TEXT_HOVER}")
